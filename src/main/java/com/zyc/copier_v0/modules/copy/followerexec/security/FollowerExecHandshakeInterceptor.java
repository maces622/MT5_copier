package com.zyc.copier_v0.modules.copy.followerexec.security;
...
@Component
public class FollowerExecHandshakeInterceptor implements HandshakeInterceptor {

    public static final String TRACE_ID_ATTR = "traceId";

    private static final Logger log = LoggerFactory.getLogger(FollowerExecHandshakeInterceptor.class);

    private final FollowerExecWebSocketProperties properties;

    public FollowerExecHandshakeInterceptor(FollowerExecWebSocketProperties properties) {
    ...
    public boolean beforeHandshake(
        ...
        if (token == null || !secureEquals(token, properties.getBearerToken())) {
            log.warn(
                    "Reject follower-exec websocket handshake, traceId={}, remote={}, uri={}, authHeaderPresent={}, queryTokenPresent={}, resolvedTokenFingerprint={}, expectedTokenFingerprint={}",
                    traceId,
